...
import sys
sys.path.append("/home/ytian/GMM-VAE/GMVAE/pytorch/")


# from model.GMVAE import *
from model.GMVAE_DPGMM import *
...
gmvae_dpgmm = GMVAE_DPGMM(args)

history_loss = gmvae_dpgmm.train(train_loader, val_loader)
